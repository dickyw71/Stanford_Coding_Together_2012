...
- (void)testValueAfterPerformOperationPlus
{
    ...
    double d = [[self.brain class] runProgram:self.brain.program];
...
{
    [self.brain pushOperand:9];
    [self.brain performOperation:@"sqrt"];
    double d = [[self.brain class] runProgram:self.brain.program];
...
- (void)testVariableWithNoValueIsZero
{
    [self.brain pushVariableOperand:@"x"];
    double d = [[self.brain class] runProgram:self.brain.program];
    STAssertEquals(d, 0.0, @"the value of unspecified variable should be 0");    
}

- (void)testVariableWithValueIsExpectedValue
{
    [self.brain pushVariableOperand:@"x"];
    double d = [[self.brain class] runProgram:self.brain.program usingVariableValues:[NSDictionary dictionaryWithObject:[NSNumber numberWithDouble:6.0] forKey:@"x"]];
    STAssertEquals(d, 6.0, @"the value of specified variable should be as expected");        
}
